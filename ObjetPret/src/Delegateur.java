...
/**   * Methode pour avoir la liste des demandes de prêt (non acceptees) pour les objets de l'utilisateur courant**/
       public List<Emprunt> getDemandesDePret() {    
    	   return pretControlleur.getDemandesDePret();
       }

/**   * Methode pour definir l'etat d'une demande de prêt comme acceptee ou refusee   * @param demande - l'Emprunt represantant la demande de pret a traiter   * @param accepte - <code>true</code> si la demande est acceptee, <code>false</code> si elle est refusee   **/
