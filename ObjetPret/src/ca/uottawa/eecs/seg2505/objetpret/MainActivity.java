...
public class MainActivity extends ActionBarActivity {
    ...
    public void onChoisir(View view) {
    	 ...
    	 * normalement l'objet sera passe par l'activite
    	...
    	// mais n'est pas implemente dans notre version
    	...
    	if (res == null || res.isEmpty()) {
    		...
    		obj.setDescription(
    		        "F350\n"+
    		        "Il faudrait faire attention de ne pas l'abime\n"
    		);
    	} else {
    		// on prend le premier
    		obj = res.get(0);
